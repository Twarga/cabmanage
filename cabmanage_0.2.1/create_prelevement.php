...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['create_prelevement'])) {
    try {
        ...
        if ($prelevement->create()) {
            echo "Prelevement created successfully with ID: " . $prelevement->prelevement_id . "<br>";
            ...
            // Debugging information before creating facture
            echo "Facture properties: <br>";
            echo "Examen ID: " . $facture->examen_id . "<br>";
            echo "Prelevement ID: " . $facture->prelevement_id . "<br>";
            echo "Total Prix: " . $facture->total_prix . "<br>";
            echo "Prix Reduit: " . $facture->prix_reduit . "<br>";
            echo "Avance: " . $facture->avance . "<br>";
            echo "Montant Du: " . $facture->montant_du . "<br>";
            echo "Rest: " . $facture->rest . "<br>";
            echo "Date Creation: " . $facture->date_creation . "<br>";
            echo "Etat Paiement: " . $facture->etat_paiement . "<br>";

            // Create facture
            if ($facture->create()) {
                echo "Facture created successfully for prelevement_id " . $prelevement->prelevement_id . ".<br>";
            } else {
                echo "Error creating facture for prelevement_id " . $prelevement->prelevement_id . ".<br>";
                printf("Facture Error: %s.\n", $facture->conn->error);
            }
        } else {
            echo "Error creating prelevement for patient_id " . $prelevement->patient_id . ".<br>";
            printf("Prelevement Error: %s.\n", $prelevement->conn->error);
        }
    } catch (Exception $e) {
