    ...
    <div class="container">
        <div class="top-bar">
            ...
            <div class="nav-buttons">
                ...
                <button class="nav-button" onclick="location.href='assitant_dashboard.php'">Examen</button>
            </div>
                ...
                <tbody>
                    <?php foreach ($patients as $patient) : ?>
                        <tr>
                            ...
                            <td>
                                <button class="add-btn" onclick="location.href='create_prelevement_assistant.php?patient_id=<?php echo $patient['patient_id']; ?>'"><img src="Front/imag/add.png" alt="add"></button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
