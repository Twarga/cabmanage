...
// Fetch all patients or search results
$patients = [];
$search_term = '';
    ...
    <div class="container">
        <div class="top-bar">
            ...
            <div class="nav-buttons">
                ...
                <button class="nav-button" onclick="location.href='assistant_dashboard.php'">Examen</button>
            </div>
        ...
        <div class="content-area">
            ...
            <h1 class="header">Patient Liste</h1>
            <div class="search-container">
                <form method="post" action="patient_management_assistance.php" style="display: flex; width: 100%;">
                ...
                <button class="new-patient-btn" onclick="location.href='create_patient_assistance.php'"><img src="Front/imag/add.png" alt="New Patient"> Nouveau Patient</button>
            </div>
                    ...
                    <tbody>
                        <?php foreach ($patients as $patient) { ?>
                            <tr>
                                ...
                                <td>
                                    <button class="view-btn" onclick="location.href='view_patient_assistance.php?id=<?php echo $patient['patient_id']; ?>'"><img src="Front/imag/view.png" alt="View"></button>
