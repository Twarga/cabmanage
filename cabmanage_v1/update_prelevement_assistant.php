                ...
                <div class="left-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="dropdown-search">
                            <input type="text" id="search_docteur_exterieur" placeholder="Search Docteur Exterieur" value="<?php echo htmlspecialchars($prelevement_data['docteur_exterieur_id']); ?>">
                        ...
                        <input type="hidden" id="docteur_exterieur_id" name="docteur_exterieur_id" value="<?php echo htmlspecialchars($prelevement_data['docteur_exterieur_id']); ?>" required>
                    </div>
                    <div class="form-group">
